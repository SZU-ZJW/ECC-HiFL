...
class EmbeddingIndex(ABC):
    ...
    def retrieve(self, mock=False):
        ...
        if not os.path.exists(persist_dir) or mock:
            ...
            if mock:
                ...
                embed_model = OpenAIEmbedding(
                    model_name=EP.embedding_model_name,
                    api_base=EP.embedding_api_base,
                    api_key=EP.embedding_api_key
                )
        ...
        retriever = VectorIndexRetriever(index=index, similarity_top_k=100, embed_model=embed_model)
